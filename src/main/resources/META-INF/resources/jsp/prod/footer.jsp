        ...
        <div class="d-flex justify-content-center text-center">
            <a target="_blank" class="text-decoration-none text-white" href="https://github.com/HHNebula">
                ...
                <span>SOO</span>
                    ...
                    <a target="_blank" class="text-decoration-none text-white" href="https://github.com/BoGyeong1 ">
                <i class="fs-1 bi bi-github text-white p-2"></i>
                <br>
                <span>GYEONG</span>
            </a>
            <a target="_blank" class="text-decoration-none text-white" href="https://github.com/Ryuyeonjoo">
                <i class="fs-1 bi bi-github text-white p-2"></i>
                <br>
                <span>JOO</span>
            </a>
